...
export class StyleSwitcher extends Widget {
	...
	static type = new NodeType('StyleSwitcher', 'style-switcher', 
		Widget.type, StyleSwitcher);

	// ------------------------------------------------------- PROTECTED FIELDS
	
	/** The value of the StyleSwitcher. */
	...
	constructor(name: string, parent: Node, data?: any) {
		...
		circle.animations['switch'] = new Animation(
			circle, 'r', ir, or, 0, 0.25, false);
		circle2.animations['switch'] = new Animation(
			circle2, 'r', 0, 20, 0, 0.25, false);
		...
		function changed() { 
			...
			(this.ancestor(UserInterface) as UserInterface).style.value =
