...
export class Simple<ValueType> extends Node {

	// --------------------------------------------------------------- METADATA

	/** The type metadata of the Simple class. */
	static type = new NodeType('Simple', 'simple', null, Simple);
	...
	/** The default value of the Simple data type. */
	get default(): ValueType { return this._default; }
	set default(newDefault: ValueType) { 
		if (this._default == newDefault) return;
	...
	constructor(name: string, parent?: Node, data?: any, 
		type: NodeType = Node.type,	def?: ValueType) {
	...
	deserialize(data: any) { this.value = data; }


	/** Serializes the instance to a JSON representation.
	 * @param params The serialization parameters.
	 * @returns The serialized data. */
	serialize(params: any = {}): any { return this.value; }
